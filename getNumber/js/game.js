function Ship(ctx){
	gameMonitor.im.loadImage(['../images/game/player.png']);
	this.width = 80;
	this.height = 80;
	this.left = gameMonitor.w/2 - this.width/2;
	this.top = gameMonitor.h - 2*this.height;
	this.player = gameMonitor.im.createImage('../images/game/player.png');
...
function Food(type, left, id){
	...
	var p = this.type == 0 ? '../images/game/food1.png' : '../images/game/food2.png';
